<template>
  <div class="w-full" style="min-width: 125px;">
    ...
    <div class="p-2 w-full" :class="{ 'text-gray-300': !inputValue, 'dl-fix': dlFix }" style="white-space: pre-wrap;" @click="showInput = true" v-show="!showInput">{{ inputValue || placeholder }}</div>
  </div>
</template>
