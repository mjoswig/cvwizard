        ...
        <div class="flex items-center mt-8">
          <div class="w-1/4">
            ...
            <div class="mt-2" v-show="settings.sectionVisibility.nationality">
              <TextField class="block font-bold text-2xl w-full" :style="{ 'color': settings.color.hex }" type="text" placeholder="Nationality" v-model="cvData.nationality.label" />
              <TextField class="block text-lg w-full" type="text" placeholder="Enter your nationality" v-model="cvData.nationality.value" />
            </div>
            ...
            <div class="mt-2" v-show="settings.sectionVisibility.maritalStatus">
              <TextField class="block font-bold text-2xl w-full" :style="{ 'color': settings.color.hex }" type="text" placeholder="Marital status" v-model="cvData.maritalStatus.label" />
            ...
            <div class="mt-4 flex items-center space-x-2 pl-2" v-show="settings.sectionVisibility.email">
              ...
              <input class="block text-lg w-full" type="text" placeholder="Enter your email" v-model="cvData.email.value" />
            </div>
            <div class="mt-4 flex items-center space-x-2 pl-2" v-show="settings.sectionVisibility.phoneNumber">
              ...
              <input class="block text-lg w-full" type="text" placeholder="Enter your phone number" v-model="cvData.phoneNumber.value" />
            </div>
            <div class="mt-4 flex items-center space-x-2 pl-2" v-show="settings.sectionVisibility.website">
              ...
              <input class="block text-lg w-full" type="text" placeholder="Enter URL without http://" v-model="cvData.website.value" />
            </div>
            <div class="mt-4 flex items-center space-x-2 pl-2" v-show="settings.sectionVisibility.linkedIn">
              ...
              <input class="block text-lg w-full" type="text" placeholder="Enter only your username" v-model="cvData.linkedIn.value" />
            </div>
            <div class="mt-4 flex items-center space-x-2 pl-2" v-show="settings.sectionVisibility.facebook">
              ...
              <input class="block text-lg w-full" type="text" placeholder="Enter only your username" v-model="cvData.facebook.value" />
            </div>
            <div class="mt-4 flex items-center space-x-2 pl-2" v-show="settings.sectionVisibility.twitter">
              ...
              <input class="block text-lg w-full" type="text" placeholder="Enter only your username" v-model="cvData.twitter.value" />
            </div>
            <div class="mt-4 flex items-center space-x-2 pl-2" v-show="settings.sectionVisibility.gitHub">
              ...
              <input class="block text-lg w-full" type="text" placeholder="Enter only your username" v-model="cvData.gitHub.value" />
            </div>
            <div class="mt-4 flex items-center space-x-2 pl-2" v-show="settings.sectionVisibility.instagram">
              ...
              <input class="block text-lg w-full" type="text" placeholder="Enter only your username" v-model="cvData.instagram.value" />
            </div>
          </div>
          <div class="w-3/4">
          </div>
