    ...
    <div v-show="showToolbar" class="mb-8 w-full">
      <div class="bg-gray-700 font-bold text-center rounded-md grid grid-cols-3 md:grid-cols-6 gap-4 md:gap-6 py-4" style="max-width: 21cm;">
        ...
        <div class="flex flex-col justify-end">
          ...
          <span class="uppercase" style="color: #f0abfc;">Download</span>
        </div>
      </div>
    </div>
      ...
      <div id="cv" ref="cv" class="relative bg-white shadow-lg w-full">
        ...
        <div class="flex items-center w-full">
            ...
            <label for="cv-picture">
              <div class="profile-picture-placeholder bg-gray-100 cursor-pointer flex items-center justify-center rounded-full" :class="{ 'h-36 w-36': settings.textSize == 'small', 'h-48 w-48': settings.textSize != 'small' }">
                <div v-show="profilePictureFileBase64 === null">
                  <div class="flex justify-center" :class="{ 'mb-1': settings.textSize != 'small' }">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-camera-fill" viewBox="0 0 16 16" :class="{ 'h-6 w-6': settings.textSize == 'small', 'h-8 w-8': settings.textSize != 'small' }">
          ...
          <div style="width: 14cm;">
            <TextField :dl-fix="isDownloading" class="block font-bold w-full" :class="{ 'text-2xl': settings.textSize === 'small', 'text-4xl': settings.textSize === 'medium', 'text-6xl': settings.textSize === 'large' }" :text-size="settings.textSize" :style="{ 'color': settings.color.hex }" type="text" placeholder="Your name" v-model="cvData.name.value" v-show="settings.sectionVisibility.name" />
        ...
        <div class="flex mt-4" :class="{ 'space-x-8': leftColumnVisible && rightColumnVisible }">
          <div class="mt-1" :style="{ 'width': rightColumnVisible ? '7cm' : '100%' }" v-show="leftColumnVisible">
            ...
            <div class="mt-2" v-show="settings.sectionVisibility.birthDate || settings.sectionVisibility.nationality || settings.sectionVisibility.address || settings.sectionVisibility.maritalStatus">
              <TextField :dl-fix="isDownloading" class="block font-bold uppercase w-full" :class="{ 'text-sm': settings.textSize === 'small', 'text-lg': settings.textSize === 'medium', 'text-2xl': settings.textSize === 'large' }" :text-size="settings.textSize" type="text" placeholder="Personal details" v-model="cvData.personalDetails.label" />
            </div>
            <div v-show="settings.sectionVisibility.birthDate">
              <TextField :dl-fix="isDownloading" class="block font-bold w-full" :class="{ 'text-sm': settings.textSize === 'small', 'text-lg': settings.textSize === 'medium', 'text-2xl': settings.textSize === 'large' }" :text-size="settings.textSize" :style="{ 'color': settings.color.hex }" type="text" placeholder="Birth date" v-model="cvData.birthDate.label" />
              <TextField :dl-fix="isDownloading" class="block w-full" :class="{ 'text-xs': settings.textSize === 'small', 'text-sm': settings.textSize === 'medium', 'text-lg': settings.textSize === 'large' }" :text-size="settings.textSize" type="text" placeholder="Enter your birth date" v-model="cvData.birthDate.value" />
            </div>
            <div v-show="settings.sectionVisibility.nationality">
              <TextField :dl-fix="isDownloading" class="block font-bold w-full" :class="{ 'text-sm': settings.textSize === 'small', 'text-lg': settings.textSize === 'medium', 'text-2xl': settings.textSize === 'large' }" :text-size="settings.textSize" :style="{ 'color': settings.color.hex }" type="text" placeholder="Nationality" v-model="cvData.nationality.label" />
              <TextField :dl-fix="isDownloading" class="block w-full" :class="{ 'text-xs': settings.textSize === 'small', 'text-sm': settings.textSize === 'medium', 'text-lg': settings.textSize === 'large' }" :text-size="settings.textSize" type="text" placeholder="Enter your nationality" v-model="cvData.nationality.value" />
            </div>
            <div v-show="settings.sectionVisibility.address">
              <TextField :dl-fix="isDownloading" class="block font-bold w-full" :class="{ 'text-sm': settings.textSize === 'small', 'text-lg': settings.textSize === 'medium', 'text-2xl': settings.textSize === 'large' }" :text-size="settings.textSize" :style="{ 'color': settings.color.hex }" type="text" placeholder="Address" v-model="cvData.address.label" />
              <TextField :dl-fix="isDownloading" class="block w-full" :class="{ 'text-xs': settings.textSize === 'small', 'text-sm': settings.textSize === 'medium', 'text-lg': settings.textSize === 'large' }" :text-size="settings.textSize" type="text" placeholder="Enter your address" v-model="cvData.address.value" />
            </div>
            <div v-show="settings.sectionVisibility.maritalStatus">
              <TextField :dl-fix="isDownloading" class="block font-bold w-full" :class="{ 'text-sm': settings.textSize === 'small', 'text-lg': settings.textSize === 'medium', 'text-2xl': settings.textSize === 'large' }" :text-size="settings.textSize" :style="{ 'color': settings.color.hex }" type="text" placeholder="Marital status" v-model="cvData.maritalStatus.label" />
              <TextField :dl-fix="isDownloading" class="block w-full" :class="{ 'text-xs': settings.textSize === 'small', 'text-sm': settings.textSize === 'medium', 'text-lg': settings.textSize === 'large' }" :text-size="settings.textSize" type="text" placeholder="Enter your marital status" v-model="cvData.maritalStatus.value" />
            </div>
            <div class="mt-2 mb-3" v-show="settings.sectionVisibility.email || settings.sectionVisibility.phoneNumber || settings.sectionVisibility.website || settings.sectionVisibility.linkedIn || settings.sectionVisibility.facebook || settings.sectionVisibility.twitter || settings.sectionVisibility.gitHub || settings.sectionVisibility.instagram">
              <TextField :dl-fix="isDownloading" class="block font-bold uppercase w-full" :class="{ 'text-sm': settings.textSize === 'small', 'text-lg': settings.textSize === 'medium', 'text-2xl': settings.textSize === 'large' }" :text-size="settings.textSize" type="text" placeholder="Contact" v-model="cvData.contact.label" />
            </div>
            <div class="mt-1 flex items-center pl-2" v-show="settings.sectionVisibility.email">
              ...
              <TextField :dl-fix="isDownloading" class="block w-full" :class="{ 'text-xs': settings.textSize === 'small', 'text-sm': settings.textSize === 'medium', 'text-lg': settings.textSize === 'large' }" type="text" placeholder="Enter your email" v-model="cvData.email.value" />
            </div>
            <div class="mt-1 flex items-center pl-2" v-show="settings.sectionVisibility.phoneNumber">
              ...
              <TextField :dl-fix="isDownloading" class="block w-full" :class="{ 'text-xs': settings.textSize === 'small', 'text-sm': settings.textSize === 'medium', 'text-lg': settings.textSize === 'large' }" type="text" placeholder="Enter your phone number" v-model="cvData.phoneNumber.value" />
            </div>
            <div class="mt-1 flex items-center pl-2" v-show="settings.sectionVisibility.website">
              ...
              <TextField :dl-fix="isDownloading" class="block w-full" :class="{ 'text-xs': settings.textSize === 'small', 'text-sm': settings.textSize === 'medium', 'text-lg': settings.textSize === 'large' }" type="text" placeholder="Enter URL without http://" v-model="cvData.website.value" />
            </div>
            <div class="mt-1 flex items-center pl-2" v-show="settings.sectionVisibility.linkedIn">
              ...
              <TextField :dl-fix="isDownloading" class="block w-full" :class="{ 'text-xs': settings.textSize === 'small', 'text-sm': settings.textSize === 'medium', 'text-lg': settings.textSize === 'large' }" type="text" placeholder="Enter only your username" v-model="cvData.linkedIn.value" />
            </div>
            <div class="mt-1 flex items-center pl-2" v-show="settings.sectionVisibility.facebook">
              ...
              <TextField :dl-fix="isDownloading" class="block w-full" :class="{ 'text-xs': settings.textSize === 'small', 'text-sm': settings.textSize === 'medium', 'text-lg': settings.textSize === 'large' }" type="text" placeholder="Enter only your username" v-model="cvData.facebook.value" />
            </div>
            <div class="mt-1 flex items-center pl-2" v-show="settings.sectionVisibility.twitter">
              ...
              <TextField :dl-fix="isDownloading" class="block w-full" :class="{ 'text-xs': settings.textSize === 'small', 'text-sm': settings.textSize === 'medium', 'text-lg': settings.textSize === 'large' }" type="text" placeholder="Enter only your username" v-model="cvData.twitter.value" />
            </div>
            <div class="mt-1 flex items-center pl-2" v-show="settings.sectionVisibility.gitHub">
              ...
              <TextField :dl-fix="isDownloading" class="block w-full" :class="{ 'text-xs': settings.textSize === 'small', 'text-sm': settings.textSize === 'medium', 'text-lg': settings.textSize === 'large' }" type="text" placeholder="Enter only your username" v-model="cvData.gitHub.value" />
            </div>
          ...
          <div :style="{ 'width': leftColumnVisible ? '14cm' : '100%' }" v-show="rightColumnVisible">
                  ...
                  <div class="flex space-x-2 items-center">
                    ...
                    <div class="w-full">
                      <div class="flex justify-between w-full">
                        <TextField :dl-fix="isDownloading" class="block font-bold uppercase w-full" :class="{ 'text-xs': settings.textSize === 'small', 'text-sm': settings.textSize === 'medium', 'text-lg': settings.textSize === 'large' }" :text-size="settings.textSize" type="text" placeholder="Employer" v-model="cvData.workExperience.positions[indexWx].employer" />
                        <TextField :dl-fix="isDownloading" class="block text-right" :class="{ 'text-xs': settings.textSize === 'small', 'text-sm': settings.textSize === 'medium', 'text-lg': settings.textSize === 'large' }" :text-size="settings.textSize" type="text" placeholder="From – Until" v-model="cvData.workExperience.positions[indexWx].timeSpan" />
                      </div>
                      <TextField :dl-fix="isDownloading" class="block w-full" :class="{ 'text-xs': settings.textSize === 'small', 'text-sm': settings.textSize === 'medium', 'text-lg': settings.textSize === 'large' }" :text-size="settings.textSize" type="text" placeholder="In this text field your can describe your duties. Try to focus on your new experiences and accomplishments." v-model="cvData.workExperience.positions[indexWx].description" />
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div v-show="settings.sectionVisibility.education">
              <TextField :dl-fix="isDownloading" class="block font-bold uppercase w-full" :class="{ 'text-sm': settings.textSize === 'small', 'text-lg': settings.textSize === 'medium', 'text-2xl': settings.textSize === 'large' }" :text-size="settings.textSize" type="text" placeholder="Education" v-model="cvData.education.label" />
              <div class="flex flex-col w-full">
            ...
            <div v-show="settings.sectionVisibility.skills1">
              <TextField :dl-fix="isDownloading" class="block font-bold uppercase w-full" :class="{ 'text-sm': settings.textSize === 'small', 'text-lg': settings.textSize === 'medium', 'text-2xl': settings.textSize === 'large' }" :text-size="settings.textSize" type="text" placeholder="Skills 1" v-model="cvData.skills1.label" />
              <div class="flex flex-wrap p-2">
                <div class="group relative mb-2 mr-2 w-max" v-for="(skill, index) in cvData.skills1.values" :key="index">
                  <TagField :dl-fix="isDownloading" :class="{ 'text-xs': settings.textSize === 'small', 'text-sm': settings.textSize === 'medium', 'text-lg': settings.textSize === 'large' }" placeholder="Enter skill" v-model="cvData.skills1.values[index]" />
            ...
            <div v-show="settings.sectionVisibility.skills2">
              <TextField :dl-fix="isDownloading" class="block font-bold uppercase w-full" :class="{ 'text-sm': settings.textSize === 'small', 'text-lg': settings.textSize === 'medium', 'text-2xl': settings.textSize === 'large' }" :text-size="settings.textSize" type="text" placeholder="Skills 2" v-model="cvData.skills2.label" />
              <div class="flex flex-wrap p-2">
                <div class="group relative mb-2 mr-2 w-max" v-for="(skill, index) in cvData.skills2.values" :key="index">
                  <TagField :dl-fix="isDownloading" :class="{ 'text-xs': settings.textSize === 'small', 'text-sm': settings.textSize === 'medium', 'text-lg': settings.textSize === 'large' }" placeholder="Enter skill" v-model="cvData.skills2.values[index]" />
                  <div class="absolute mt-1 right-0 flex space-x-2 opacity-0 group-hover:opacity-100">
