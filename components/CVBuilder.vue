    ...
    <div class="overflow-scroll">
      <div class="bg-white p-12 shadow-lg w-full" style="width: 1340px;">
        <div class="flex items-center">
          ...
          <div class="w-3/4">
            <TextField class="block font-bold w-full" :class="{ 'text-4xl': settings.textSize === 'small', 'text-6xl': settings.textSize === 'medium', 'text-8xl': settings.textSize === 'large' }" :text-size="settings.textSize"  :style="{ 'color': settings.color.hex }" type="text" placeholder="Your name" v-model="cvData.name.value" v-show="settings.sectionVisibility.name" />
            <TextField class="block font-bold uppercase w-full" :class="{ 'text-lg': settings.textSize === 'small', 'text-2xl': settings.textSize === 'medium', 'text-4xl': settings.textSize === 'large' }" :text-size="settings.textSize" type="text" placeholder="Your profession or specialty" v-model="cvData.profession.value" v-show="settings.sectionVisibility.profession" />
          </div>
        </div>
        <div class="flex mt-8">
          <div class="w-1/4 mt-1">
            <div v-show="settings.sectionVisibility.profile">
              <TextField class="block font-bold uppercase w-full" :class="{ 'text-lg': settings.textSize === 'small', 'text-2xl': settings.textSize === 'medium', 'text-4xl': settings.textSize === 'large' }" :text-size="settings.textSize" type="text" placeholder="Profile" v-model="cvData.profile.label" />
              <TextField class="block w-full" :class="{ 'text-sm': settings.textSize === 'small', 'text-lg': settings.textSize === 'medium', 'text-2xl': settings.textSize === 'large' }" :text-size="settings.textSize" type="text" placeholder="Write here a paragraph about yourself." v-model="cvData.profile.value" />
            </div>
            <div class="mt-4" v-show="settings.sectionVisibility.birthDate || settings.sectionVisibility.nationality || settings.sectionVisibility.address || settings.sectionVisibility.maritalStatus">
              <TextField class="block font-bold uppercase w-full" :class="{ 'text-lg': settings.textSize === 'small', 'text-2xl': settings.textSize === 'medium', 'text-4xl': settings.textSize === 'large' }" :text-size="settings.textSize" type="text" placeholder="Personal details" v-model="cvData.personalDetails.label" />
            </div>
            <div class="mt-2" v-show="settings.sectionVisibility.birthDate">
              <TextField class="block font-bold w-full" :class="{ 'text-lg': settings.textSize === 'small', 'text-2xl': settings.textSize === 'medium', 'text-4xl': settings.textSize === 'large' }" :text-size="settings.textSize" :style="{ 'color': settings.color.hex }" type="text" placeholder="Birth date" v-model="cvData.birthDate.label" />
              <TextField class="block w-full" :class="{ 'text-sm': settings.textSize === 'small', 'text-lg': settings.textSize === 'medium', 'text-2xl': settings.textSize === 'large' }" :text-size="settings.textSize" type="text" placeholder="Enter your birth date" v-model="cvData.birthDate.value" />
            </div>
            <div class="mt-2" v-show="settings.sectionVisibility.nationality">
              <TextField class="block font-bold w-full" :class="{ 'text-lg': settings.textSize === 'small', 'text-2xl': settings.textSize === 'medium', 'text-4xl': settings.textSize === 'large' }" :text-size="settings.textSize" :style="{ 'color': settings.color.hex }" type="text" placeholder="Nationality" v-model="cvData.nationality.label" />
              <TextField class="block w-full" :class="{ 'text-sm': settings.textSize === 'small', 'text-lg': settings.textSize === 'medium', 'text-2xl': settings.textSize === 'large' }" :text-size="settings.textSize" type="text" placeholder="Enter your nationality" v-model="cvData.nationality.value" />
            </div>
            <div class="mt-2" v-show="settings.sectionVisibility.address">
              <TextField class="block font-bold w-full" :class="{ 'text-lg': settings.textSize === 'small', 'text-2xl': settings.textSize === 'medium', 'text-4xl': settings.textSize === 'large' }" :text-size="settings.textSize" :style="{ 'color': settings.color.hex }" type="text" placeholder="Address" v-model="cvData.address.label" />
              <TextField class="block w-full" :class="{ 'text-sm': settings.textSize === 'small', 'text-lg': settings.textSize === 'medium', 'text-2xl': settings.textSize === 'large' }" :text-size="settings.textSize" type="text" placeholder="Enter your address" v-model="cvData.address.value" />
            </div>
            <div class="mt-2" v-show="settings.sectionVisibility.maritalStatus">
              <TextField class="block font-bold w-full" :class="{ 'text-lg': settings.textSize === 'small', 'text-2xl': settings.textSize === 'medium', 'text-4xl': settings.textSize === 'large' }" :text-size="settings.textSize" :style="{ 'color': settings.color.hex }" type="text" placeholder="Marital status" v-model="cvData.maritalStatus.label" />
              <TextField class="block w-full" :class="{ 'text-sm': settings.textSize === 'small', 'text-lg': settings.textSize === 'medium', 'text-2xl': settings.textSize === 'large' }" :text-size="settings.textSize" type="text" placeholder="Enter your marital status" v-model="cvData.maritalStatus.value" />
            </div>
            <div class="mt-4" v-show="settings.sectionVisibility.email || settings.sectionVisibility.phoneNumber || settings.sectionVisibility.website || settings.sectionVisibility.linkedIn || settings.sectionVisibility.facebook || settings.sectionVisibility.twitter || settings.sectionVisibility.gitHub || settings.sectionVisibility.instagram">
              <TextField class="block font-bold uppercase w-full" :class="{ 'text-lg': settings.textSize === 'small', 'text-2xl': settings.textSize === 'medium', 'text-4xl': settings.textSize === 'large' }" :text-size="settings.textSize" type="text" placeholder="Contact" v-model="cvData.contact.label" />
            </div>
            <div class="mt-4 flex items-center space-x-2 pl-2" v-show="settings.sectionVisibility.email">
              ...
              <input class="block w-full" :class="{ 'text-sm': settings.textSize === 'small', 'text-lg': settings.textSize === 'medium', 'text-2xl': settings.textSize === 'large' }" type="text" placeholder="Enter your email" v-model="cvData.email.value" />
            </div>
            <div class="mt-4 flex items-center space-x-2 pl-2" v-show="settings.sectionVisibility.phoneNumber">
              <div class="p-2 rounded-full" :style="{ 'background-color': settings.color.hex }">
              ...
              <input class="block w-full" :class="{ 'text-sm': settings.textSize === 'small', 'text-lg': settings.textSize === 'medium', 'text-2xl': settings.textSize === 'large' }" type="text" placeholder="Enter your phone number" v-model="cvData.phoneNumber.value" />
            </div>
            <div class="mt-4 flex items-center space-x-2 pl-2" v-show="settings.sectionVisibility.website">
              <div class="p-2 rounded-full" :style="{ 'background-color': settings.color.hex }">
              ...
              <input class="block w-full" :class="{ 'text-sm': settings.textSize === 'small', 'text-lg': settings.textSize === 'medium', 'text-2xl': settings.textSize === 'large' }" type="text" placeholder="Enter URL without http://" v-model="cvData.website.value" />
            </div>
            <div class="mt-4 flex items-center space-x-2 pl-2" v-show="settings.sectionVisibility.linkedIn">
              <div class="p-2 rounded-full" :style="{ 'background-color': settings.color.hex }">
              ...
              <input class="block w-full" :class="{ 'text-sm': settings.textSize === 'small', 'text-lg': settings.textSize === 'medium', 'text-2xl': settings.textSize === 'large' }" type="text" placeholder="Enter only your username" v-model="cvData.linkedIn.value" />
            </div>
            <div class="mt-4 flex items-center space-x-2 pl-2" v-show="settings.sectionVisibility.facebook">
              <div class="p-2 rounded-full" :style="{ 'background-color': settings.color.hex }">
              ...
              <input class="block w-full" :class="{ 'text-sm': settings.textSize === 'small', 'text-lg': settings.textSize === 'medium', 'text-2xl': settings.textSize === 'large' }" type="text" placeholder="Enter only your username" v-model="cvData.facebook.value" />
            </div>
            <div class="mt-4 flex items-center space-x-2 pl-2" v-show="settings.sectionVisibility.twitter">
              <div class="p-2 rounded-full" :style="{ 'background-color': settings.color.hex }">
              ...
              <input class="block w-full" :class="{ 'text-sm': settings.textSize === 'small', 'text-lg': settings.textSize === 'medium', 'text-2xl': settings.textSize === 'large' }" type="text" placeholder="Enter only your username" v-model="cvData.twitter.value" />
            </div>
            <div class="mt-4 flex items-center space-x-2 pl-2" v-show="settings.sectionVisibility.gitHub">
              <div class="p-2 rounded-full" :style="{ 'background-color': settings.color.hex }">
              ...
              <input class="block w-full" :class="{ 'text-sm': settings.textSize === 'small', 'text-lg': settings.textSize === 'medium', 'text-2xl': settings.textSize === 'large' }" type="text" placeholder="Enter only your username" v-model="cvData.gitHub.value" />
            </div>
            <div class="mt-4 flex items-center space-x-2 pl-2" v-show="settings.sectionVisibility.instagram">
              <div class="p-2 rounded-full" :style="{ 'background-color': settings.color.hex }">
              ...
              <input class="block w-full" :class="{ 'text-sm': settings.textSize === 'small', 'text-lg': settings.textSize === 'medium', 'text-2xl': settings.textSize === 'large' }" type="text" placeholder="Enter only your username" v-model="cvData.instagram.value" />
            </div>
          </div>
          <div class="w-3/4">
            <div class="mb-4" v-show="settings.sectionVisibility.workExperience">
              <TextField class="block font-bold uppercase w-full" :class="{ 'text-lg': settings.textSize === 'small', 'text-2xl': settings.textSize === 'medium', 'text-4xl': settings.textSize === 'large' }" :text-size="settings.textSize" type="text" placeholder="Work experience" v-model="cvData.workExperience.label" />
              <div class="flex flex-col space-y-4 w-full">
                <div class="group relative ml-3" v-for="(position, indexWx) in cvData.workExperience.positions" :key="indexWx">
                  ...
                  <div class="flex space-x-2 items-center">
                    ...
                    <div class="w-3/4">
                      <TextField class="block font-bold w-full" :class="{ 'text-lg': settings.textSize === 'small', 'text-2xl': settings.textSize === 'medium', 'text-4xl': settings.textSize === 'large' }" :text-size="settings.textSize" :style="{ 'color': settings.color.hex }" type="text" placeholder="Position" v-model="cvData.workExperience.positions[indexWx].position" />
                    </div>
                  </div>
                  <div class="flex space-x-2 items-center">
                    <div>
                    ...
                    <div class="w-full">
                      <div class="flex justify-between w-full">
                        <TextField class="block font-bold uppercase w-full" :class="{ 'text-xs': settings.textSize === 'small', 'text-base': settings.textSize === 'medium', 'text-xl': settings.textSize === 'large' }" :text-size="settings.textSize" type="text" placeholder="Employer" v-model="cvData.workExperience.positions[indexWx].employer" />
                        <TextField class="block text-right" :class="{ 'text-xs': settings.textSize === 'small', 'text-base': settings.textSize === 'medium', 'text-xl': settings.textSize === 'large' }" :text-size="settings.textSize" type="text" placeholder="From – Until" v-model="cvData.workExperience.positions[indexWx].timeSpan" />
                      </div>
                      <TextField class="block w-full" :class="{ 'text-xs': settings.textSize === 'small', 'text-base': settings.textSize === 'medium', 'text-xl': settings.textSize === 'large' }" :text-size="settings.textSize" type="text" placeholder="In this text field your can describe your duties. Try to focus on accomplishments that serve as concrete examples to the type of problems you can solve to your future employer." v-model="cvData.workExperience.positions[indexWx].description" />
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="flex flex-col space-y-4 w-full">
                <div class="group relative ml-3" v-for="(position, indexEd) in cvData.education.degrees" :key="indexEd">
                  ...
                  <div class="flex space-x-2 items-center">
                    ...
                    <div class="w-full">
                      <TextField class="block font-bold w-3/4" :class="{ 'text-lg': settings.textSize === 'small', 'text-2xl': settings.textSize === 'medium', 'text-4xl': settings.textSize === 'large' }" :text-size="settings.textSize" :style="{ 'color': settings.color.hex }" type="text" placeholder="Degree" v-model="cvData.education.degrees[indexEd].degree" />
                    </div>
                  </div>
                  <div class="flex space-x-2 items-center">
                    <div>
                    ...
                    <div class="w-full">
                      <div class="flex justify-between w-full">
                        <TextField class="block font-bold uppercase w-full" :class="{ 'text-xs': settings.textSize === 'small', 'text-base': settings.textSize === 'medium', 'text-xl': settings.textSize === 'large' }" :text-size="settings.textSize" type="text" placeholder="School" v-model="cvData.education.degrees[indexEd].degree" />
                        <TextField class="block text-right" :class="{ 'text-xs': settings.textSize === 'small', 'text-base': settings.textSize === 'medium', 'text-xl': settings.textSize === 'large' }" :text-size="settings.textSize" type="text" placeholder="From – Until" v-model="cvData.education.degrees[indexEd].timeSpan" />
                      </div>
                    </div>
                  </div>
                </div>
