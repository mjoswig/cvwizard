<template>
  <article class="page-content">
    <section class="mb-12">
      ...
      <p class="sm:text-center text-xl mb-6">Our CV templates will show you the skills, and achievements you need to land work in 2023.</p>
    ...
    <section class="grid grid-cols-3 gap-6">
      ...
      <nuxt-link to="/cv-templates/artificial-intelligence-researcher">
        ...
        <h2 class="text-xl">Artificial Intelligence Researcher CV</h2>
      </nuxt-link>
    </section>
  </article>
</template>
