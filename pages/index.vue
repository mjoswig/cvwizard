  ...
  <article class="page-content">
    ...
    <section class="mb-12">
      ...
      <div class="grid md:grid-cols-2 gap-8">
        ...
        <div>
          <h3 class="mb-2">Privacy-friendly</h3>
    ...
    <section>
      ...
      <div class="mb-8">
        <h3 class="mb-2">How long should a CV be?</h3>
      ...
      <div class="mb-8">
        <h3 class="mb-2">What should I put on my CV?</h3>
      ...
      <div class="mb-8">
        <h3 class="mb-2">How to list references on a CV?</h3>
      ...
      <div>
        <h3 class="mb-2">How should a CV look?</h3>
